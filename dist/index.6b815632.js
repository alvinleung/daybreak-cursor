...
window.addEventListener("DOMContentLoaded", ()=>{
    const cursorInfo = (0, _cursor.createCursor)();
});

},{"./cursor":"ldTvF"}],"ldTvF":[function(require,module,exports) {
...
function createCursor() {
    ...
    function destroyCursor(cursorInfo) {
        document.body.removeChild(cursorInfo.elm);
        window.removeEventListener("mousemove", handleMouseMove);
    }
    return cursorInfo;
}
function updateCursorElement(cursorInfo) {
...
},{}]},["4ibyE","kuM8f"], "kuM8f", "parcelRequiredf02")
